 ...
 * 
 */
function(e){e.fn.picture=function(t){var n={container:null,ignorePixelRatio:!1},r=e.extend({},n,t);this.each(function(){function t(t){if(t)if("figure"==s.get(0).tagName.toLowerCase()){var l=s.data();e.each(l,function(e){var t;t=e.replace(/[^\d.]/g,""),t&&u.push(t)})}else s.find("source").each(function(){var t,n;t=e(this).attr("media"),t&&(n=t.replace(/[^\d.]/g,""),u.push(n))});var f=0;o=null==r.container?e(window).width()*c:e(r.container).width()*c,e.each(u,function(e,t){parseInt(o)>=parseInt(t)&&parseInt(f)<=parseInt(t)&&(f=t)}),a!==f&&(a=f,"figure"==s.get(0).tagName.toLowerCase()?i():n())}function n(){var t=new Object;if(s.find("source").each(function(){var n,r,i;n=e(this).attr("media"),r=e(this).attr("src"),i=n?n.replace(/[^\d.]/g,""):0,t[i]=r}),0==s.find("img").length){var n='<img src="'+t[a]+'" style="'+s.attr("style")+'" alt="'+s.attr("alt")+'">';0==e(">a",s).length?s.append(n):e(">a",s).append(n)}else s.find("img").attr("src",t[a])}function i(){var t=new Object,n=s.data();if(e.each(n,function(e,n){var r;r=e.replace(/[^\d.]/g,""),r||(r=0),t[r]=n}),0==s.find("img").length){var r='<img src="'+t[a]+'" alt="'+s.attr("title")+'">';0==e(">a",s).length?s.append(r):e(">a",s).append(r)}else s.find("img").attr("src",t[a])}var o,a,s,l,u=new Array,c=1;r.ignorePixelRatio||void 0===window.devicePixelRatio||(c=window.devicePixelRatio),s=e(this),t(!0),l=!1,e(window).resize(function(){l!==!1&&clearTimeout(l),l=setTimeout(t,200)})})}}(jQuery),Modernizr.addTest("boxsizing",function(){return Modernizr.testAllProps("boxSizing")&&(void 0===document.documentMode||document.documentMode>7)}),$(function(){$("html").hasClass("boxsizing")||$("*").each(function(){if("block"==$(this).css("display")){var e,t,n;e=$(this).outerWidth(),t=$(this).width(),n=t-(e-t),$(this).css("width",n)}})}),$(function(){$("figure.responsive").picture({container:$("#content")})});